...
function pageFullyLoaded(e) {
      ...
      parentContainer.find('.toggle-play').on('click', function(){
          ...
          parentContainer.find('.pause-svg').css('display', 'block');
					...
					if (screenWidth <= 600) {
						$('.bottom-player-wrapper .music-control-wrapper .toggle-play').find('.pause-svg').css('display', 'block');
						$('.bottom-player-wrapper .music-control-wrapper .toggle-play').find('.play-svg').css('display', 'none');
					}
        }
          ...
          widget.pause();
					...
					if (screenWidth <= 600) {
						$('.bottom-player-wrapper .music-control-wrapper .toggle-play').find('.pause-svg').css('display', 'none');
						$('.bottom-player-wrapper .music-control-wrapper .toggle-play').find('.play-svg').css('display', 'block');
					}
        }
				toggleVar += 1;
          ...
          seekVar = seekVar % 6;
			...
			$('.bottom-player-wrapper .music-control-wrapper .toggle-play').on('click', function() {
				...
				if (toggleVar % 2 == 1) {
					...
					$('#myNav .tm .music-control-wrapper').find('.pause-svg').css('display', 'none');
					$('#myNav .tm .music-control-wrapper').find('.play-svg').css('display', 'block');
				}
			});
